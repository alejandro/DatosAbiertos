 ...
 * @api public
 */
function BasicWithTokenStrategy(options, verify) {
 ...
 */
util.inherits(BasicWithTokenStrategy, passport.Strategy);
 ...
 * @api protected
 */
BasicWithTokenStrategy.prototype.authenticate = function(req) {
  ...
  if (self._passReqToCallback) {
    this._verify(req, userid, password, token, verified);
  } else {
    this._verify(userid, password, token, verified);
  }
}
/**
 ...
 * @api private
 */
BasicWithTokenStrategy.prototype._challenge = function() {
  return 'Basic realm="' + this._realm + '"';
}
/**
 * Expose `BasicStrategy`.
 */
module.exports = BasicWithTokenStrategy;
