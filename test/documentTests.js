...
describe('Documents', function() {
	...
	var collectionId = 'a test collection';
	...
	describe('when modifying the data in a document', function() {
		...
		describe('where document doesn\'t follow the validation rules', function() {
			it('should fail with validation errors', function(done) {
				...
				database.collection(collectionId.toString()).then(function(c) {
					c.add(userId, testDocument).then(function(doc) {
						collectionDataModule.modify(userId, collectionId, doc._id, changes)
						.then(function() {
							done('No validation error was returned.');
						}).fail(function(err) {
		...
		// 			c.add(userId, testDocument).then(function(doc) {
		// 				console.log('added doc to collection');
		// 				collectionDataModule.modify(userId, collectionId.toString(), doc._id, changes).then(function(modifiedDocument) {
